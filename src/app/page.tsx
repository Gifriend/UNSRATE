          ...
          <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-md">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                Belum punya akun? <Link href="/register" className="text-pink-600 font-medium">Daftar sekarang</Link>
              </p>
            </div>
            
            {/* Tombol langsung masuk untuk pengembangan */}
            <div className="mt-6 pt-6 border-t border-gray-200">
              <Link href="/swipe" className="block w-full py-2 px-4 bg-gray-100 hover:bg-gray-200 text-center text-gray-700 rounded-lg transition">
